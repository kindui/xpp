X.add({
    ...
    _init: function () {
        ...
        this.el = this.df('<div class="xtoast" style="top: 40%;"></div>');
        this.elInfo = this.df('<div></div>');
        this.el.appendChild(this.elInfo);
        this.css('top', this.top);
        this.on(document, 'DOMContentLoaded', function () {
            document.body.appendChild(this.el);
        });
    },
    show: function (msg) {
        msg && (this.elInfo.innerHTML = msg);
        this.css({
            visibility: 'visible',
            opacity: 1
        });
    ...
    text: function (msg) {
        msg = msg || '';
        this.setText().show(msg);
    },
    success: function (msg) {
        msg = msg || '';
        this.setSuccess().show(msg);
    },
    error: function (msg) {
        msg = msg || '';
        this.setError().show(msg);
    },
    setSuccess: function () {
        this.elInfo.className = 'success';
        return this;
    },
    setError: function () {
        this.elInfo.className = 'error';
        return this;
    },
    setText: function () {
        this.elInfo.className = '';
        return this;
    },
    setTime: function (t) {
        this.time = t;
    ...
    setHeight: function (h) {
        this.css.call(this.elInfo, 'height', h);
        this.css.call(this.elInfo, 'lineHeight', h);
        return this;
    },
    getCss: function () {
        var s = '\
        ...
        .xtoast .success:before,.xtoast .error:before{\
            content: "";\
            display: block;\
            height: 35px;\
            width: 35px;\
